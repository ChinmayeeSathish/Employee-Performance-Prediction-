...
def load_data(file):
    return pd.read_excel("C:/Users/91845/Downloads/Employee data FINAL.xlsx")
...
def main():
    ...
    uploaded_file = st.file_uploader("C:/Users/91845/Downloads/Employee data FINAL.xlsx", type=["xlsx"])
    ...
    if uploaded_file is not None:
        ...
        if st.button("Save Inputs to New Excel"):
            ...
            new_file = "C:/Users/91845/OneDrive/Documents/store data.xlsx"
        ...
        if st.button("Compare Performance"):
            new_data = pd.read_excel("C:/Users/91845/OneDrive/Documents/store data.xlsx")
